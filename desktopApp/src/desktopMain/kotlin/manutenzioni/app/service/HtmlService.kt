...
class HtmlService(
    ...
    private fun buildComponentiSheet(
        ...
        sb.appendLine("""        <div class="sheet--componenti" style="page-break-before: always; break-before: page; margin-top: 0.6cm;">""")
        ...
        sb.appendLine()
        sb.appendLine("""            <!-- Tabella Intestazione Scheda Differenziali -->""")
        sb.appendLine("""            <table style="width: 100%; border-collapse: collapse; table-layout: fixed; margin-bottom: 0.35cm;">""")
        sb.appendLine("""                <colgroup>""")
        sb.appendLine("""                    <col style="width: 3.5cm;" />""")
        sb.appendLine("""                    <col style="width: 2.5cm;" />""")
        sb.appendLine("""                    <col style="width: 9.0cm;" />""")
        ...
        sb.appendLine("""                    </td>""")
        sb.appendLine("""                    <td style="border: 0.0133cm solid #000; background-color: #b4c6e7; padding: 2px 4px; vertical-align: top;">""")
        sb.appendLine("""                        <p style="font-size: 5pt; margin: 0;">Oggetto scheda:</p>""")
        sb.appendLine("""                        <p style="font-size: 6.5pt; font-weight: bold; margin: 0;">DIFF</p>""")
        sb.appendLine("""                    </td>""")
        sb.appendLine("""                    <td style="border: 0.0133cm solid #000; background-color: #3366ff; color: #ffffff; text-align: center; vertical-align: middle; padding: 2px 4px;">""")
        ...
        sb.appendLine("""                    </td>""")
        sb.appendLine("""                    <td style="border: 0.0133cm solid #000; background-color: #b4c6e7; padding: 2px 4px; vertical-align: top;">""")
        sb.appendLine("""                        <table style="width: 100%; border-collapse: collapse; border: none;">""")
        sb.appendLine("""                            <tr>""")
        sb.appendLine("""                                <td style="width: 45%; border: none; padding: 0; vertical-align: top;">""")
        ...
        sb.appendLine("""                                </td>""")
        sb.appendLine("""                                <td style="width: 55%; border: none; padding: 0; vertical-align: top;">""")
        ...
        sb.appendLine("""                    <td colspan="3" style="border: 0.0133cm solid #000; padding: 2px 4px; vertical-align: top;">""")
        ...
        sb.appendLine("""            </table>""")
        sb.appendLine()
        sb.appendLine("""            <!-- Tabella Dati Interruttori Differenziali -->""")
        sb.appendLine("""            <table style="width: 100%; border-collapse: collapse; table-layout: fixed; page-break-inside: auto;">""")
        sb.appendLine("""                <colgroup>""")
        sb.appendLine("""                    <col style="width: 2.8cm;" />""")
        sb.appendLine("""                    <col style="width: 2.2cm;" />""")
        sb.appendLine("""                    <col style="width: 5.2cm;" />""")
        sb.appendLine("""                    <col style="width: 2.5cm;" />""")
        sb.appendLine("""                    <col style="width: 1.1cm;" />""")
        sb.appendLine("""                    <col style="width: 1.4cm;" />""")
        sb.appendLine("""                    <col style="width: 1.1cm;" />""")
        sb.appendLine("""                    <col style="width: 1.4cm;" />""")
        sb.appendLine("""                    <col style="width: 2.1cm;" />""")
        sb.appendLine("""                </colgroup>""")
        sb.appendLine("""                <thead>""")
